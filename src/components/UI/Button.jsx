import styled from "styled-components"
 ...
 export const Button = ({children, variant ="contained", borderStyled="rounded"})=>{
 return <StyledButton variant={variant} borderStyled= {borderStyled}>{children}</StyledButton>
}
